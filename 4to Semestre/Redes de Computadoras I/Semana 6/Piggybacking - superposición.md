...
| ---------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| Mejor uso de ancho de banda  | **Gestión de tiempo:** si la espera es mayor al timer del emisor, este retransmitirá la trama, invalidando el propósito de la técnica. |
| Menor carga de procesamiento | **Complejidad:** requiere un esquema de *ad hoc* para equilibrar la eficiencia y la prontitud de las confirmaciones.                   |
