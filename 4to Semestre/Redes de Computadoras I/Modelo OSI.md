...
**VI. Capa de Enlace de Datos (Capa 2):** Los ***paquetes*** se introducen en ***tramas**.* Se añaden las direcciones físicas (MAC ADDRESS) y una suma de comprobación (*checksum*) al final de la trama para detectar si los bits se dañan durante el trayecto. Solamente hay servicios (no tiene protocolos).
