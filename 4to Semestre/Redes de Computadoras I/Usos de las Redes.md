...
- **Ejemplos:**
	- Bibliotecas digitales, diarios online, redes sociales, sitios de venta con contenido digital, aplicaciones web, *comunicación peer-to-peer* y contenidos personalizables.
...
- [I] **IPTV (Televisión por Protocolo de Internet):** es una tecnología que distribuye señales de televisión de pago a través de conexiones de banda ancha, en lugar de antenas o cable tradicional. Está basada en tecnología IP.
...
Se basa en la información *ubicua*, donde sensores integrados en objetos cotidianos (frigoríficos, alarmas, medidores de energía) se conectan a la red.
...
- [I] **Protocolos:** conjunto de reglas y normas que deben cumplir los dispositivos para la comunicación de datos en una red.
- [I] **ISP (Internet Service Provider):** Proveedor de servicios de internet.
- [I] **VPN (Virtual Private Network):** Es una WAN construida con enlaces virtuales que corren sobre la Internet.
