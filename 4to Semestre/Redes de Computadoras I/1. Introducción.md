...
>[!note] Concepto
>Es una colección de dispositivos informáticos autónomos interconectados (pueden intercambiar información).
...
## 3. Clasificación por Escala (Tamaño Físico)
...
- **Tipos:**
    ...
    - **Alámbricas:** Cables de cobre o [[Fibra Óptica]].
